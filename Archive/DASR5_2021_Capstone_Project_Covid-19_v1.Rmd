...
Within the dataset, Some of few key fields we are interested in reflecting current Singapore COVID-19 situation, namely Daily.Confirmed, Daily Deaths, Still.Hospitalised and Intensive.Care.Unit..ICU which will also serve as our dependent (*discrete y*) variable.
...
$$
\begin{eqnarray}
\widehat{swl} = intercept + b_1Daily.Deaths + b_2Daily.Confirmed + b_3Still.Hospitalised + b_4Intensive.Care.Unit..ICU.+ \epsilon
\end{eqnarray}
$$
...
$$
\begin{eqnarray}
\widehat{swl} = intercept + b_1Daily.Deaths + b_2Daily.Confirmed + b_3Still.Hospitalised + b_4ICU + \\ 
                    + b_5Daily.Deaths \times icu + b_6Daily.Confirmed \times icu + b_7Still.Hospitalised \times icu + \epsilon
\end{eqnarray}
$$
```{r}
